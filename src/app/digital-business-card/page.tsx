          ...
          <div className=" px-4 text-center pb-8   flex flex-col flex-1 justify-around">
            ...
            <nav className="mb-4">
              <ul className="flex flex-row items-center justify-center gap-4 text-background font-semibold">
                <li className="hover:scale-105 transition"><a href="https://wa.me/+5527992495299?text=Olá, Oi, vi seu portfólio e gostaria de saber mais sobre seus serviços." className="flex  items-center justify-center aspect-square px-4 py-4 bg-pink rounded-full"><img src="/img/logo-whatsapp.svg" alt="" className="w-10" /></a></li>
